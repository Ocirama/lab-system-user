...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["log-log-module"], {
    ...
    function () {
      ...
      _createClass(ListComponent, [{
        ...
        value: function _delete(id) {
          ...
          this.api.delete("/lei/orders/".concat(id)).subscribe(function () {
  ...
  function srcAppLogLogModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LogModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [_modal_modal_component__WEBPACK_IMPORTED_MODULE_4__["ModalComponent"]]
    })], LogModule);
    /***/
  }
}]);
//# sourceMappingURL=log-log-module-es5.js.map