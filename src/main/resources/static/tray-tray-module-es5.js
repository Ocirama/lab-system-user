...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tray-tray-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTrayTrayComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTrayTrayRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TrayRoutingModule", function () {
      return TrayRoutingModule;
    });
    /* harmony import */
    ...
    var _tray_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./tray.component */
    ...
    var TrayRoutingModule = function TrayRoutingModule() {
      _classCallCheck(this, TrayRoutingModule);
    };

    TrayRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppTrayTrayComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTrayTrayComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TrayComponent", function () {
    ...
    /*#__PURE__*/
    function () {
      function TrayComponent(api) {
        _classCallCheck(this, TrayComponent);
      ...
      _createClass(TrayComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "swalCalibration",
        value: function swalCalibration() {
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.mixin({
            input: 'text',
            confirmButtonText: 'Next &rarr;',
            showCancelButton: true,
            progressSteps: ['1', '2']
          }).queue(['Skenuokite padėklą', {
        ...
        value: function onSubmit(value) {
          this.api.post('/lei/trays', value).subscribe(function (data) {
        ...
        value: function childFunction(value) {
          ...
          this.api.get("/lei/trays/".concat(value.trayId)).subscribe(function (data) {
            _this.trays = data;
          });
        }
      }]);
    ...
    TrayComponent.ctorParameters = function () {
      return [{
        type: _core_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]
      }];
    };

    TrayComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-tray',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./tray.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/tray/tray.component.html")).default,
      providers: [_tab_service__WEBPACK_IMPORTED_MODULE_3__["TabService"]],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./tray.component.css */
      "./src/app/tray/tray.component.css")).default]
    })], TrayComponent);
    /***/
  },
  ...
  /***/
  function srcAppTrayTrayModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TrayModule", function () {
      return TrayModule;
    });
    /* harmony import */
    ...
    var _tray_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./tray-routing.module */
    "./src/app/tray/tray-routing.module.ts");
    /* harmony import */
    ...
    var TrayModule = function TrayModule() {
      _classCallCheck(this, TrayModule);
    };

    TrayModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_tray_component__WEBPACK_IMPORTED_MODULE_3__["TrayComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _tray_routing_module__WEBPACK_IMPORTED_MODULE_4__["TrayRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"]]
    })], TrayModule);
    /***/
  }
}]);
//# sourceMappingURL=tray-tray-module-es5.js.map